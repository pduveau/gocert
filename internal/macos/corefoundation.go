...
func BytesToCFData(b []byte) CFRef {
	...
	ret := syscall(FuncPCABI0(x509_CFDataCreate_trampoline), kCFAllocatorDefault, uintptr(p), uintptr(len(b)), 0, 0, 0)
	runtime.KeepAlive(p)
	return CFRef(ret)
}
...
func StringToCFString(s string) CFString {
	...
	ret := syscall(FuncPCABI0(x509_CFStringCreateWithBytes_trampoline), kCFAllocatorDefault, uintptr(p),
...
func CFDictionaryGetValueIfPresent(dict CFRef, key CFString) (value CFRef, ok bool) {
	ret := syscall(FuncPCABI0(x509_CFDictionaryGetValueIfPresent_trampoline), uintptr(dict), uintptr(key),
...
func CFNumberGetValue(num CFRef) (int32, error) {
	var value int32
	ret := syscall(FuncPCABI0(x509_CFNumberGetValue_trampoline), uintptr(num), uintptr(kCFNumberSInt32Type),
		uintptr(unsafe.Pointer(&value)), 0, 0, 0)
	if ret == 0 {
...
func CFDataGetLength(data CFRef) int {
	ret := syscall(FuncPCABI0(x509_CFDataGetLength_trampoline), uintptr(data), 0, 0, 0, 0, 0)
	return int(ret)
}
...
func CFDataGetBytePtr(data CFRef) uintptr {
	ret := syscall(FuncPCABI0(x509_CFDataGetBytePtr_trampoline), uintptr(data), 0, 0, 0, 0, 0)
	return ret
}
...
func CFArrayGetCount(array CFRef) int {
	ret := syscall(FuncPCABI0(x509_CFArrayGetCount_trampoline), uintptr(array), 0, 0, 0, 0, 0)
	return int(ret)
}
...
func CFArrayGetValueAtIndex(array CFRef, index int) CFRef {
	ret := syscall(FuncPCABI0(x509_CFArrayGetValueAtIndex_trampoline), uintptr(array), uintptr(index), 0, 0, 0, 0)
	return CFRef(ret)
}
...
func CFEqual(a, b CFRef) bool {
	ret := syscall(FuncPCABI0(x509_CFEqual_trampoline), uintptr(a), uintptr(b), 0, 0, 0, 0)
	return ret == 1
}
...
func CFRelease(ref CFRef) {
	syscall(FuncPCABI0(x509_CFRelease_trampoline), uintptr(ref), 0, 0, 0, 0, 0)
}
...
func CFArrayCreateMutable() CFRef {
	ret := syscall(FuncPCABI0(x509_CFArrayCreateMutable_trampoline), kCFAllocatorDefault, 0, 0 /* kCFTypeArrayCallBacks */, 0, 0, 0)
	return CFRef(ret)
}
...
func CFArrayAppendValue(array CFRef, val CFRef) {
	syscall(FuncPCABI0(x509_CFArrayAppendValue_trampoline), uintptr(array), uintptr(val), 0, 0, 0, 0)
}
...
func CFDateCreate(seconds float64) CFRef {
	ret := syscall(FuncPCABI0(x509_CFDateCreate_trampoline), kCFAllocatorDefault, 0, 0, 0, 0, seconds)
	return CFRef(ret)
}
...
func CFErrorCopyDescription(errRef CFRef) CFRef {
	ret := syscall(FuncPCABI0(x509_CFErrorCopyDescription_trampoline), uintptr(errRef), 0, 0, 0, 0, 0)
	return CFRef(ret)
}
...
func CFErrorGetCode(errRef CFRef) int {
	return int(syscall(FuncPCABI0(x509_CFErrorGetCode_trampoline), uintptr(errRef), 0, 0, 0, 0, 0))
}
...
func CFStringCreateExternalRepresentation(strRef CFRef) (CFRef, error) {
	ret := syscall(FuncPCABI0(x509_CFStringCreateExternalRepresentation_trampoline), kCFAllocatorDefault, uintptr(strRef), kCFStringEncodingUTF8, 0, 0, 0)
	if ret == 0 {
