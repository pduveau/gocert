...
var derEncodedSelfSignedCert = Certificate{
	TBSCertificate: TBSCertificate{
		...
		Issuer: RDNSequence{
			...
			RelativeDistinguishedNameSET{AttributeTypeAndValue{Type: ObjectIdentifier{1, 2, 840, 113549, 1, 9, 1}, Value: IA5String("false@example.com")}},
		},
		Validity: Validity{
...
func TestStringTypeForGenericStructureBasedOnAny(t *testing.T) {
	type tagged struct {
		IA5       any
		Printable any
		UTF8      any
	...
	a := tagged{
		IA5:       IA5String("ia5"),
		Printable: "printable",
		UTF8:      UTF8String("ñéèà"),
		T61:       T61String("T61"),
		Numeric:   NUMERICString("123 456"),
		Bmp:       BMPString("異體字"),
	}
	var wanted = []byte{
		byte(TagSequence) | 0x20 /* Compound */, 0x00,
		byte(TagIA5String), 0x03, 'i', 'a', '5',
		byte(TagPrintableString), 0x09, 'p', 'r', 'i', 'n', 't', 'a', 'b', 'l', 'e',
		byte(TagUTF8String), 0x08, 0xc3, 0xb1, 0xc3, 0xa9, 0xc3, 0xa8, 0xc3, 0xa0,
		byte(TagT61String), 0x03, 'T', '6', '1',
		byte(TagNumericString), 0x07, '1', '2', '3', ' ', '4', '5', '6',
		byte(TagBMPString), 0x06, 0x75, 0x70, 0x9a, 0xd4, 0x5b, 0x57,
	}
	wanted[1] = byte(len(wanted) - 2)
	...
	if !reflect.DeepEqual(enc, wanted) {
